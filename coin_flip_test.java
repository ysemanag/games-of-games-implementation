import java.util.*;
 ...
 //Constructor
 public coin_flip_test(){
        round_num = 0;
 }
 
 //displays the description of the game to the user.
 ...
 private int random_flip(int range){
 ...
 private void display_scoreboard(){
        System.out.println("SCOREBOARD");                                        //undefined label
        System.out.println("Guesser: " + guesser_points + " points.");
        System.out.println("Computer: " + computer_points + " points.");
        System.out.println();
  }

 //converts the random number generated when computer flips the coin into an ‘H’ or ‘T’ in order to be compared with the input inserted by the user.
 ...
 public static void main(String args[]){
        ...
        coin_flip_test game = new coin_flip_test();
